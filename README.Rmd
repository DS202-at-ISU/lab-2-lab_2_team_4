...
3.  Sale Price is the main variable. The range of sale price is 0 - 20500000. The general pattern is that there is a large skew in the data, where the count of sales price concentrates in the left. Some oddities include the two outliers that lie to the right at a significantly higher sale price.
...
The range of Acres is 0.0000 - 12.0120.
The distribution of the count of Acres is very similar to the distribution of the Sale Price, where is it skewed and concentrated to the left.

The overall pattern of the scatterplot confirms the correlation between the Sale Price and Acres. They both concentrate towards lower prices and less acres. However, Acres does not appear to have as extreme oddities as compared to Sale Price.
