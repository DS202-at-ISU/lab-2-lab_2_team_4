...
Arina's work: Variable picked = YearBuilt

The variable YearBuilt ranges from the late 1800s to recent years, with most homes built in the mid-to-late 1900s. The scatterplot shows that newer homes generally sell for higher prices, while older homes tend to sell for less. Outliers, such as very old houses with high prices or newer houses with low prices, suggest that factors beyond age also influence sale price.
